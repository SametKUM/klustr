export namespace kube {
	...
	export class ArgoApplicationCondition {
	    type: string;
	    message: string;
	
	    static createFrom(source: any = {}) {
	        return new ArgoApplicationCondition(source);
	    }
	...
	export class ArgoApplicationHealth {
	    status: string;
	    message: string;
	    destServer: string;
	    destName: string;
	    destNamespace: string;
	    resourceHealthPersisted: boolean;
	    conditions: ArgoApplicationCondition[];
	
	    static createFrom(source: any = {}) {
	        return new ArgoApplicationHealth(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.resourceHealthPersisted = source["resourceHealthPersisted"];
	        this.conditions = this.convertValues(source["conditions"], ArgoApplicationCondition);
	    }
